...
<div class="page-wrapper">
    ...
    <div class="container">
        <form action="{{route('post.update',$post->id)}}" style="margin-top: 50px" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                <div class=" form-group">
                    <textarea class="ckeditor" rows="5" cols="500" required name="body">{{$post->body}}</textarea>
                </div>
            </div>
