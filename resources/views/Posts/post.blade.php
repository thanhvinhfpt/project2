    ...
    <div class="container">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tr>
                ...
                <th class="header_table" style="width:15%">Cover</th>
                <th class="header_table" style="width:15%">Title</th>
                <th class="header_table" style="width:40%">Body</th>
                <th class="header_table" style="width:10%">Tag</th>
                <th class="header_table" style="width:20%">Author</th>
                <th class="header_table" style="width:20%">Created at</th>
            ...
            @foreach($lsPost as $post)
                <tr>
                    ...
                    <td>{{$post->id}}</td>
                    <td><img src="{{$post->coverImage}}" height="60px" width="100px" alt="cover Image"></td>
                    <td>{{$post->title}}</td>
                    ...
                    <td>
                        <div class="row-cols-6">
                            <a class="mdi mdi-pencil btn-primary btn-style"
                               href="{{route('post.edit', $post->id)}}"> </a>
