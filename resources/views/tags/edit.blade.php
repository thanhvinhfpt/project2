...
<div class="page-wrapper">
    ...
    <div class="container">
        <form action="{{route('tag.update',$tag->id )}}" style="margin-top: 50px" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <label for="name"><b>Enter name</b></label>
            <div class="form-group">
                <input type="text" class="form-control" placeholder="name" id="title" name="name" value="{{$tag->name}}">
            </div>
