...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($name != null){
            $lsUser = User::where('name','=',$name)->where('role_name','=','EMPLOYEE')->orderBy('created_at', 'desc')->paginate(10);
        }else {
            $lsUser = User::where('role_name','=','EMPLOYEE')->orderBy('created_at', 'desc')->paginate(10);
        }
